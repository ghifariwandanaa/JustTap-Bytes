...
<html lang="en">
    <head>
        ...
        <title>Bytes - Let's Grow Up Your Bussiness With Us!</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-5">
                <a class="navbar-brand fw-bold" href="#page-top">Bytes Company</a>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            <h1 class="display-1 lh-1 mb-3">Make Your Own Business Card.</h1>
                            <p class="lead fw-normal text-muted mb-5">Empower Your Connections: Your Business Card, Your Brand Story.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- Masthead device mockup feature-->
                        <div class="masthead-device-mockup">
                            <img src="{{asset('landingpage')}}/assets/img/card.gif" alt="GIF" width="400" height="225">
                            ...
                            {{-- <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        ...
                                        <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%"><source src="{{asset('landingpage')}}/assets/img/demo-screen.mp4" type="video/mp4" /></video>
                                    </div>
                                </div>
                            </div> --}}
                        </div>
        ...
        <aside class="text-center bg-gradient-primary-to-secondary">
            <div class="container px-5">
                <div class="row gx-5 justify-content-center">
                    <div class="col-xl-8">
                        <div class="h2 fs-1 text-white mb-4">"A business card is the key to unlocking doors to unexpected opportunities."</div>
                        <img src="{{asset('landingpage')}}/assets/img/logopattern.svg" alt="..." style="height: 3rem" />
                    </div>
                </div>
            </div>
        </aside>
                            ...
                            <div class="row gx-5">
                                <div class="col-md-6 mb-5">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h3 class="font-alt">Hadir di Setiap Gadget</h3>
                                        <p class="text-muted mb-0">Tampilan yang Konsisten di Semua Jenis Perangkat yang Anda Miliki!</p>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-5">
                                    <!-- Feature item-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h3 class="font-alt">Keamanan Terpercaya</h3>
                                        <p class="text-muted mb-0">Data Anda Selalu Aman: Dilindungi dengan Teknologi Keamanan Terpercaya!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        ...
                                        <!-- * * Set the max width of your media to 100% and the height to-->
                                        <!-- * * 100% like the demo example below.-->
                                        <img src="{{asset('landingpage')}}/assets/img/webscreen.jpg" style="max-width: 101%; height: 101%" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div class="col-sm-8 col-md-6">
                        <div class="px-5 px-sm-0">
                            <img class="img-fluid rounded-circle" src="{{asset('landingpage')}}/assets/img/sticker.png" alt="..." /></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-gradient-primary-to-secondary" id="contactUs">
            <div class="container px-5">
                ...
                <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center">
                    <a class="me-lg-3 mb-4 mb-lg-0" href="https://www.instagram.com/yourfuture.bytes/"><img class="app-badge" src="{{asset('landingpage')}}/assets/img/instagram.png" alt="..." /></a>
                    <a href="https://wa.me/62895639838070"><img class="app-badge" src="{{asset('landingpage')}}/assets/img/whatsapp.png" alt="..." /></a>
                </div>
            </div>
        </section>
        <!-- Footer-->
        <footer class="bg-black text-center py-5">
            <div class="container px-5">
                <div class="text-white-50 small">
                    <div class="mb-2">&copy; Bytes Company.</div>
                    <a>It's small but it's big</a>
                </div>
            </div>
        </footer>
        <!-- Bootstrap core JS-->
